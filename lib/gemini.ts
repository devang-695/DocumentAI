...
export async function analyzeWithGemin(
    text: string,
    ...
    try {
        ...
        const prompts = {
            ...
            sentiment: `Analysis the sentiment and tone of the following document. Provide overall sentiment (positive/negetive/neutral) add key emotional tones detected:\n\n${text}`,
